...
# Peer Review: Nice job loading all your packages up front! One little note that you don't need both `tidyverse` *and* `dplyr` since tidyverse already loads dplyr.
```
...
# Peer review: Great use of list.files() + lapply() to batch-read the Excel files! Those are new to me and I am happy to learn those new functions! If you want to be extra reproducible, you may also consider using here("data", "fruit-2020"). 
...
# Peer review: Great job! I just reformat the code a bit to increase readability. 
```
...
# Peer review: This logic is very clear and clever. I learned this fill-then-filter pattern from your script!
# Peer review: Given that your fruit and veg pipelines are very similar, another option is to wrap the logic into a helper function and then apply to both datasets to reduce repetition. But your current code is already very clear and readable! Well-done!
```
...
# Peer reivew: Great job! The case_when is very readable! It might be nice to turn these summaries into a small gt/kable table or plot. 
```
...
# Peer review: your modeling code is very clear and nicely annotated! This is such an interesting project!
```
